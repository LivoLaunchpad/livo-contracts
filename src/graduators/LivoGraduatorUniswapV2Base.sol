...
/// @title LivoGraduatorUniswapV2Base
...
/// @dev Abstract: never deployed directly. See `LivoGraduatorUniswapV2` (ETH) and
///      `LivoGraduatorUniswapV2Arc` (ARC).
abstract contract LivoGraduatorUniswapV2Base is ILivoGraduator {
