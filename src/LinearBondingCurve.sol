...
contract LinearBondingCurve is ILivoBondingCurve {
    ...
    function getBuyPrice(uint256 ethAmount, uint256 currentSupply, uint256 ethSupply) external pure override returns (uint256) {
    ...
    function getSellPrice(uint256 tokenAmount, uint256 currentSupply, uint256 ethSupply) external pure override returns (uint256) {
        return _getEthForTokens(tokenAmount, currentSupply, ethSupply);
    }
    
    function getTokensForEth(uint256 ethAmount, uint256 currentSupply, uint256 ethSupply) external pure override returns (uint256) {
        return _getTokensForEth(ethAmount, currentSupply, ethSupply);
    }
    
    function getEthForTokens(uint256 tokenAmount, uint256 currentSupply, uint256 ethSupply) external pure override returns (uint256) {
        return _getEthForTokens(tokenAmount, currentSupply, ethSupply);
    }
    
    function _getTokensForEth(uint256 ethAmount, uint256 currentSupply, uint256 ethSupply) internal pure returns (uint256) {
    ...
    function _getEthForTokens(uint256 tokenAmount, uint256 currentSupply, uint256 ethSupply) internal pure returns (uint256) {
