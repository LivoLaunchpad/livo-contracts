...
contract ExportDeployments is Script {
    ...
    struct ChainDeployments {
        ...
        address graduatorThin0p5;
        address graduatorThick;
        address graduatorThick0p5;
    ...
    function _ethereumMainnet() internal pure returns (ChainDeployments memory d) {
        ...
        d.graduatorUniV4_0p5 = DeploymentsEthereumMainnet.GRADUATOR_UNIV4_0P5;
        ...
        d.graduatorThin0p5 = DeploymentsEthereumMainnet.GRADUATOR_UNIV4_THIN_0P5;
        d.graduatorThick = DeploymentsEthereumMainnet.GRADUATOR_UNIV4_THICK;
        d.graduatorThick0p5 = DeploymentsEthereumMainnet.GRADUATOR_UNIV4_THICK_0P5;
    ...
    function _ethereumSepolia() internal pure returns (ChainDeployments memory d) {
        ...
        d.graduatorUniV4_0p5 = DeploymentsEthereumSepolia.GRADUATOR_UNIV4_0P5;
        ...
        d.graduatorThin0p5 = DeploymentsEthereumSepolia.GRADUATOR_UNIV4_THIN_0P5;
        d.graduatorThick = DeploymentsEthereumSepolia.GRADUATOR_UNIV4_THICK;
        d.graduatorThick0p5 = DeploymentsEthereumSepolia.GRADUATOR_UNIV4_THICK_0P5;
    ...
    function _robinhoodMainnet() internal pure returns (ChainDeployments memory d) {
        ...
        d.graduatorUniV4_0p5 = DeploymentsRobinhoodMainnet.GRADUATOR_UNIV4_0P5;
        ...
        d.graduatorThin0p5 = DeploymentsRobinhoodMainnet.GRADUATOR_UNIV4_THIN_0P5;
        d.graduatorThick = DeploymentsRobinhoodMainnet.GRADUATOR_UNIV4_THICK;
        d.graduatorThick0p5 = DeploymentsRobinhoodMainnet.GRADUATOR_UNIV4_THICK_0P5;
    ...
    function _robinhoodTestnet() internal pure returns (ChainDeployments memory d) {
        ...
        d.graduatorUniV4_0p5 = DeploymentsRobinhoodTestnet.GRADUATOR_UNIV4_0P5;
        ...
        d.graduatorThin0p5 = DeploymentsRobinhoodTestnet.GRADUATOR_UNIV4_THIN_0P5;
        d.graduatorThick = DeploymentsRobinhoodTestnet.GRADUATOR_UNIV4_THICK;
        d.graduatorThick0p5 = DeploymentsRobinhoodTestnet.GRADUATOR_UNIV4_THICK_0P5;
    ...
    function _render(ChainDeployments memory d) internal pure returns (string memory s) {
        ...
        s = string.concat(s, _row("LivoGraduatorUniswapV4 (0.5% hook)", d.graduatorUniV4_0p5));
        s = string.concat(s, _row("LivoMasterFeeHandler", d.masterFeeHandler));
        s = string.concat(s, _row("LivoSwapHook", d.swapHook));
        s = string.concat(s, _row("LivoSwapHook (0.5%)", d.swapHook0p5));
        ...
        s = string.concat(s, _row("LivoGraduatorUniV4 THIN (0.5%)", d.graduatorThin0p5));
        s = string.concat(s, _row("LivoGraduatorUniV4 THICK", d.graduatorThick));
        s = string.concat(s, _row("LivoGraduatorUniV4 THICK (0.5%)", d.graduatorThick0p5));
