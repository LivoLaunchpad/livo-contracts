<!-- Frozen archive of Livo's pre-launchpad-v2 (v1) Mainnet deployments. Hand-maintained snapshot — NOT regenerated by `just export-deployments`. The live manifest (`deployments.mainnet.md`) tracks the launchpad-v2 deployments. -->
